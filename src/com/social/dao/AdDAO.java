...
public class AdDAO {
	...
	public TAd getById(long id) throws Exception {
		TAd d = null;
		try {
			d = (TAd) session.get(TAd.class, id);
		} catch (Exception e) {
	...
	public List<TAd> getByQuery(String conditions, long start,
...
//	}
	...
	public TAd add(TAd d) throws Exception {
		Long id = null;
	...
	public TAd update(TAd d) throws Exception {
		try {
			session.update(d);
		}
