...
/**
 * Servlet implementation class NearbyGroupListServlet
 */
@WebServlet("/NearbyGroupListServlet")
public class NearbyGroupListServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			list_tgroup = dao.getByQuery("state=1", 0, 0);
			...
			root.success = true;
			root.message = "";
			root.group_list = list_group_for_client;
